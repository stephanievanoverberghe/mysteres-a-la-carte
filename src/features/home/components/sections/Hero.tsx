  ...
  return (
    <section id="hero" ref={rootRef} className="relative isolate overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, rgba(0,0,0,0.45) 0%, rgba(0,0,0,0.25) 35%, rgba(0,0,0,0.55) 100%)',
        }}
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -top-24 -left-24 h-168 w-2xl -z-10 rounded-full blur-3xl opacity-50"
        style={{
      ...
      <div
        aria-hidden
        className="max-md:hidden pointer-events-none absolute inset-0 -z-5 opacity-[0.08] mix-blend-soft-light bg-[url('/textures/noise.webp')] bg-repeat bg-size-[40px_240px] animate-[noise-pan_14s_linear_infinite]"
      />
      ...
      <LazyMotion features={domAnimation}>
        ...
        >
          ...
          <div className="mx-auto max-w-3xl text-center md:text-left md:mx-8 lg:mx-0">
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="text-primary relative inline-block overflow-hidden">
                  ...
                  <span
                    aria-hidden
                    className="pointer-events-none absolute inset-y-0 -left-full w-1/2 bg-linear-to-r from-transparent via-white/40 to-transparent mix-blend-screen will-change-transform animate-[sweep_2.4s_ease-in-out_infinite]"
                  />
                </span>
                <motion.span
                  aria-hidden
            ...
            <motion.p
              variants={fadeUp}
              className="mt-6 mx-auto md:mx-0 max-w-2xl text-lg text-white/80"
            >
              Indices cachés dans les plats, complicité en salle, 60–90&nbsp;min de sensations à
              partager.
            </motion.p>
            ...
            <motion.div
              variants={fadeUp}
              className="mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-start sm:gap-4"
            >
              <Magnetic>
              ...
              <a
                href="#concept"
                className="inline-flex w-full items-center justify-center gap-2 underline underline-offset-4 hover:text-primary sm:w-auto"
              >
                Voir le concept
              </a>
            </motion.div>
            ...
            <motion.div
              variants={fadeUp}
              className="mt-10 flex flex-wrap justify-center md:justify-start gap-3 text-sm text-white/80"
            >
              <span className="rounded-xl border border-white/20 bg-black/30 px-3 py-1 backdrop-blur">
                Durée 60–90 min
              </span>
              <span className="rounded-xl border border-white/20 bg-black/30 px-3 py-1 backdrop-blur">
                2–6 joueurs
      ...
      <a
        href="#concept"
        className="group absolute left-1/2 bottom-6 -translate-x-1/2 hidden md:inline-flex items-center gap-2 text-sm text-white/80 hover:text-primary z-20"
      >
