...
const ITEMS = [
  {
    icon: Lightbulb,
    title: 'Jouez',
    desc: 'Des indices cachés dans les menus, les plats et l’ambiance.',
  },
  {
    icon: UtensilsCrossed,
    title: 'Dégustez',
    desc: 'Chaque bouchée révèle une piste. Comparez, savourez.',
  },
  {
    icon: Users,
    title: 'Collaborez',
    desc: 'Le service vous aiguille juste ce qu’il faut, en équipe.',
  },
] as const;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-10">
            <div className="max-w-2xl order-2 lg:order-1">
              ...
              <p className="mt-3 text-muted-foreground">
                Une expérience immersive qui mêle jeu d’enquête et gastronomie. 60 à 90 minutes,
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    aria-hidden
                    className="absolute inset-0 bg-linear-to-tr from-black/30 via-transparent to-black/20"
                  />
                </motion.div>
                ...
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(closest-side, rgba(212,175,55,0.25), transparent 70%)',
                  }}
                />
              </motion.div>
            </motion.div>
