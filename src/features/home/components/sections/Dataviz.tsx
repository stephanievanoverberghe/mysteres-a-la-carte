          ...
          >
            <motion.div variants={blockV} className="max-w-2xl">
              ...
              <p className="mt-3 text-muted-foreground">
                Chez nos joueurs tests, les{' '}
                <span className="text-foreground">indices gustatifs</span> sont les plus décisifs.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="mt-4 text-xs text-muted-foreground">
                Données internes issues d’ateliers tests (n ≈ 120). Échantillon indicatif.
              </div>
            </motion.div>
          </motion.div>
        </div>
