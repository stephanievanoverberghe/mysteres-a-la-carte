'use client';
import { Car, Clock, Mail, MapPin, Navigation, Phone, Train } from 'lucide-react';
            ...
            <motion.div variants={blockV} className="flex items-start gap-3">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-3 text-muted-foreground">
                  Retrouvez-nous à Bastille. Écrivez-nous ou réservez votre table.
                </p>
              </div>
            </motion.div>
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <motion.div variants={blockV} className="space-y-6">
                <section
                  ...
                  className="rounded-2xl border border-muted bg-background/60 p-6 shadow-soft"
                >
                ...
                <section
                  aria-labelledby="contact-infos-title"
                  className="rounded-2xl border border-muted bg-background/60 p-6 shadow-soft"
                >
              ...
              <motion.div
                variants={blockV}
                className="rounded-2xl border border-muted bg-background/60 overflow-hidden shadow-soft"
              >
                <div className="aspect-4/3 w-full">
                  <iframe
                    title="Carte - Mystères à la carte"
                    src={MAPS_EMBED}
                    loading="lazy"
                ...
                <div className="p-4 text-xs text-muted-foreground">
                  Astuce : arrivez 10 minutes en avance pour le brief de table.
                </div>
              </motion.div>
            </div>
          </motion.div>
