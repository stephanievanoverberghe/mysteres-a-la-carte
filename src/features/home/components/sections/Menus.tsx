        ...
        <div className="md:px-10 lg:px-0">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-muted-foreground">
              Quatre parcours à la carte. Choisissez votre mystère.
            </p>
          </div>
                  ...
                  {m.tags.length > 0 && (
                    <div className="absolute right-4 top-4 hidden lg:flex flex-wrap gap-2">
                      {m.tags.map((t) => (
                        <span
                          key={t}
                          className="rounded-full border border-white/25 bg-black/30 px-3 py-1 text-[11px] text-white/90 backdrop-blur"
                        >
                          {t}
                        </span>
                      ))}
